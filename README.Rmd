...
You can install the development version of fastWavelets from [GitHub](https://github.com/) with:
...
In the context of forecasting, everything to the left of the vertical dashed blue line would be removed prior to training a forecasting model using the MODWT coefficients. It is often useful to view wavelet decomposition methods such as the MODWT
as a "feature generation" or "feature engineering" method.
